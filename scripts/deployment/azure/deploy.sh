...
export storage_accout_name=jbmanager$random_number
...
export STORAGE_ACCOUNT_URL=https://$storage_accout_name.blob.core.windows.net
export STORAGE_AUDIOFILES_CONTAINER=audiofiles
